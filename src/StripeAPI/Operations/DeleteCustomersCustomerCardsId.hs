...
data DeleteCustomersCustomerCardsIdResponseBody200 = DeleteCustomersCustomerCardsIdResponseBody200
  { -- | account: The ID of the account that the bank account is associated with.
    ...
    --
    -- * Maximum length of 5000
    deleteCustomersCustomerCardsIdResponseBody200AccountType :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
    -- | ach_credit_transfer
...
data DeleteCustomersCustomerCardsIdResponseBody200ExternalAccounts'Data' = DeleteCustomersCustomerCardsIdResponseBody200ExternalAccounts'Data'
  { -- | account: The ID of the account that the bank account is associated with.
    ...
    --
    -- * Maximum length of 5000
    deleteCustomersCustomerCardsIdResponseBody200ExternalAccounts'Data'AccountType :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
    -- | address_city: City\/District\/Suburb\/Town\/Village.
    --
    -- Constraints:
    --
