...
data DeleteCustomersCustomerSourcesIdResponseBody200 = DeleteCustomersCustomerSourcesIdResponseBody200
  { -- | account: The ID of the account that the bank account is associated with.
    ...
    --
    -- * Maximum length of 5000
    deleteCustomersCustomerSourcesIdResponseBody200AccountType :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
    -- | ach_credit_transfer
...
data DeleteCustomersCustomerSourcesIdResponseBody200ExternalAccounts'Data' = DeleteCustomersCustomerSourcesIdResponseBody200ExternalAccounts'Data'
  { -- | account: The ID of the account that the bank account is associated with.
    ...
    --
    -- * Maximum length of 5000
    deleteCustomersCustomerSourcesIdResponseBody200ExternalAccounts'Data'AccountType :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
    -- | address_city: City\/District\/Suburb\/Town\/Village.
    --
    -- Constraints:
    --
