...
data ExternalAccount = ExternalAccount
  { -- | account: The ID of the account that the bank account is associated with.
    ...
    --
    -- * Maximum length of 5000
    externalAccountAccountType :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
