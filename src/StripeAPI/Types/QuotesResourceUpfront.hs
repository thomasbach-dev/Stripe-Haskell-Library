...
instance Data.Aeson.Types.ToJSON.ToJSON QuotesResourceUpfront where
  toJSON obj = Data.Aeson.Types.Internal.object ("amount_subtotal" Data.Aeson.Types.ToJSON..= quotesResourceUpfrontAmountSubtotal obj : "amount_total" Data.Aeson.Types.ToJSON..= quotesResourceUpfrontAmountTotal obj : "line_items" Data.Aeson.Types.ToJSON..= quotesResourceUpfrontLineItems obj : "total_details" Data.Aeson.Types.ToJSON..= quotesResourceUpfrontTotalDetails obj : GHC.Base.mempty)
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("amount_subtotal" Data.Aeson.Types.ToJSON..= quotesResourceUpfrontAmountSubtotal obj) GHC.Base.<> (("amount_total" Data.Aeson.Types.ToJSON..= quotesResourceUpfrontAmountTotal obj) GHC.Base.<> (("line_items" Data.Aeson.Types.ToJSON..= quotesResourceUpfrontLineItems obj) GHC.Base.<> ("total_details" Data.Aeson.Types.ToJSON..= quotesResourceUpfrontTotalDetails obj))))
...
instance Data.Aeson.Types.ToJSON.ToJSON QuotesResourceUpfrontLineItems' where
  toJSON obj = Data.Aeson.Types.Internal.object ("data" Data.Aeson.Types.ToJSON..= quotesResourceUpfrontLineItems'Data obj : "has_more" Data.Aeson.Types.ToJSON..= quotesResourceUpfrontLineItems'HasMore obj : "url" Data.Aeson.Types.ToJSON..= quotesResourceUpfrontLineItems'Url obj : "object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list" : GHC.Base.mempty)
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("data" Data.Aeson.Types.ToJSON..= quotesResourceUpfrontLineItems'Data obj) GHC.Base.<> (("has_more" Data.Aeson.Types.ToJSON..= quotesResourceUpfrontLineItems'HasMore obj) GHC.Base.<> (("url" Data.Aeson.Types.ToJSON..= quotesResourceUpfrontLineItems'Url obj) GHC.Base.<> ("object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"))))
