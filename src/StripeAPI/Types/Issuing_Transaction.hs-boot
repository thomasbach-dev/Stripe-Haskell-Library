...
instance Show Issuing'transactionWallet'
instance Eq Issuing'transactionWallet'
instance FromJSON Issuing'transactionWallet'
instance ToJSON Issuing'transactionWallet'
