...
data ChargePaymentMethodDetails' = ChargePaymentMethodDetails'
  { -- | ach_credit_transfer:
    ...
    -- | wechat_pay:
    chargePaymentMethodDetails'WechatPay :: (GHC.Maybe.Maybe PaymentMethodDetailsWechatPay)
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
mkChargePaymentMethodDetails' =
  ChargePaymentMethodDetails'
    { chargePaymentMethodDetails'AchCreditTransfer = GHC.Maybe.Nothing,
      ...
      chargePaymentMethodDetails'WechatPay = GHC.Maybe.Nothing
    }
