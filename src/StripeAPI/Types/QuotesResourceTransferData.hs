...
data QuotesResourceTransferData = QuotesResourceTransferData
  { -- | amount: The amount in %s that will be transferred to the destination account when the invoice is paid. By default, the entire amount is transferred to the destination.
    quotesResourceTransferDataAmount :: (GHC.Maybe.Maybe GHC.Types.Int),
    ...
    quotesResourceTransferDataAmountPercent :: (GHC.Maybe.Maybe GHC.Types.Double),
...
instance Data.Aeson.Types.ToJSON.ToJSON QuotesResourceTransferData where
  toJSON obj = Data.Aeson.Types.Internal.object ("amount" Data.Aeson.Types.ToJSON..= quotesResourceTransferDataAmount obj : "amount_percent" Data.Aeson.Types.ToJSON..= quotesResourceTransferDataAmountPercent obj : "destination" Data.Aeson.Types.ToJSON..= quotesResourceTransferDataDestination obj : GHC.Base.mempty)
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("amount" Data.Aeson.Types.ToJSON..= quotesResourceTransferDataAmount obj) GHC.Base.<> (("amount_percent" Data.Aeson.Types.ToJSON..= quotesResourceTransferDataAmountPercent obj) GHC.Base.<> ("destination" Data.Aeson.Types.ToJSON..= quotesResourceTransferDataDestination obj)))
