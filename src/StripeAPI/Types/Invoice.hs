...
data Invoice = Invoice
  { -- | account_country: The country of the business associated with this invoice, most often the business creating the invoice.
    ...
    invoiceQuote :: (GHC.Maybe.Maybe InvoiceQuote'Variants),
...
data InvoiceBillingReason'
  ...
  | -- | Represents the JSON value @"quote_accept"@
    InvoiceBillingReason'EnumQuoteAccept
...
instance Data.Aeson.Types.ToJSON.ToJSON InvoiceBillingReason' where
  ...
  toJSON (InvoiceBillingReason'EnumQuoteAccept) = "quote_accept"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
            ...
            | val GHC.Classes.== "quote_accept" -> InvoiceBillingReason'EnumQuoteAccept
...
data InvoiceLastFinalizationError'Source' = InvoiceLastFinalizationError'Source'
  { -- | account: The ID of the account that the bank account is associated with.
    ...
    --
    -- * Maximum length of 5000
    invoiceLastFinalizationError'Source'AccountType :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
    -- | ach_credit_transfer
...
mkInvoiceLastFinalizationError'Source' =
  InvoiceLastFinalizationError'Source'
    { invoiceLastFinalizationError'Source'Account = GHC.Maybe.Nothing,
      ...
      invoiceLastFinalizationError'Source'AccountType = GHC.Maybe.Nothing,
...
data InvoiceQuote'Variants
  = InvoiceQuote'Text Data.Text.Internal.Text
  | InvoiceQuote'Quote Quote
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON InvoiceQuote'Variants where
  toJSON (InvoiceQuote'Text a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (InvoiceQuote'Quote a) = Data.Aeson.Types.ToJSON.toJSON a

instance Data.Aeson.Types.FromJSON.FromJSON InvoiceQuote'Variants where
  parseJSON val = case (InvoiceQuote'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((InvoiceQuote'Quote Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
    Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a
    Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a
