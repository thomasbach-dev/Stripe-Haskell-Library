...
data QuotesResourceSubscriptionData = QuotesResourceSubscriptionData
  { -- | effective_date: When creating a new subscription, the date of which the subscription schedule will start after the quote is accepted. This date is ignored if it is in the past when the quote is accepted. Measured in seconds since the Unix epoch.
    quotesResourceSubscriptionDataEffectiveDate :: (GHC.Maybe.Maybe GHC.Types.Int),
    -- | trial_period_days: Integer representing the number of trial period days before the customer is charged for the first time.
    quotesResourceSubscriptionDataTrialPeriodDays :: (GHC.Maybe.Maybe GHC.Types.Int)
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON QuotesResourceSubscriptionData where
  toJSON obj = Data.Aeson.Types.Internal.object ("effective_date" Data.Aeson.Types.ToJSON..= quotesResourceSubscriptionDataEffectiveDate obj : "trial_period_days" Data.Aeson.Types.ToJSON..= quotesResourceSubscriptionDataTrialPeriodDays obj : GHC.Base.mempty)
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("effective_date" Data.Aeson.Types.ToJSON..= quotesResourceSubscriptionDataEffectiveDate obj) GHC.Base.<> ("trial_period_days" Data.Aeson.Types.ToJSON..= quotesResourceSubscriptionDataTrialPeriodDays obj))
