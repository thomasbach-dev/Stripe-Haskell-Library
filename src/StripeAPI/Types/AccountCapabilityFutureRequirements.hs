...
data AccountCapabilityFutureRequirements = AccountCapabilityFutureRequirements
  { -- | alternatives: Fields that are due and can be satisfied by providing the corresponding alternative fields instead.
    accountCapabilityFutureRequirementsAlternatives :: (GHC.Maybe.Maybe ([AccountRequirementsAlternative])),
    -- | current_deadline: Date on which \`future_requirements\` merges with the main \`requirements\` hash and \`future_requirements\` becomes empty. After the transition, \`currently_due\` requirements may immediately become \`past_due\`, but the account may also be given a grace period depending on the capability\'s enablement state prior to transitioning.
    accountCapabilityFutureRequirementsCurrentDeadline :: (GHC.Maybe.Maybe GHC.Types.Int),
    ...
    accountCapabilityFutureRequirementsDisabledReason :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
...
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilityFutureRequirements where
  toJSON obj = Data.Aeson.Types.Internal.object ("alternatives" Data.Aeson.Types.ToJSON..= accountCapabilityFutureRequirementsAlternatives obj : "current_deadline" Data.Aeson.Types.ToJSON..= accountCapabilityFutureRequirementsCurrentDeadline obj : "currently_due" Data.Aeson.Types.ToJSON..= accountCapabilityFutureRequirementsCurrentlyDue obj : "disabled_reason" Data.Aeson.Types.ToJSON..= accountCapabilityFutureRequirementsDisabledReason obj : "errors" Data.Aeson.Types.ToJSON..= accountCapabilityFutureRequirementsErrors obj : "eventually_due" Data.Aeson.Types.ToJSON..= accountCapabilityFutureRequirementsEventuallyDue obj : "past_due" Data.Aeson.Types.ToJSON..= accountCapabilityFutureRequirementsPastDue obj : "pending_verification" Data.Aeson.Types.ToJSON..= accountCapabilityFutureRequirementsPendingVerification obj : GHC.Base.mempty)
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("alternatives" Data.Aeson.Types.ToJSON..= accountCapabilityFutureRequirementsAlternatives obj) GHC.Base.<> (("current_deadline" Data.Aeson.Types.ToJSON..= accountCapabilityFutureRequirementsCurrentDeadline obj) GHC.Base.<> (("currently_due" Data.Aeson.Types.ToJSON..= accountCapabilityFutureRequirementsCurrentlyDue obj) GHC.Base.<> (("disabled_reason" Data.Aeson.Types.ToJSON..= accountCapabilityFutureRequirementsDisabledReason obj) GHC.Base.<> (("errors" Data.Aeson.Types.ToJSON..= accountCapabilityFutureRequirementsErrors obj) GHC.Base.<> (("eventually_due" Data.Aeson.Types.ToJSON..= accountCapabilityFutureRequirementsEventuallyDue obj) GHC.Base.<> (("past_due" Data.Aeson.Types.ToJSON..= accountCapabilityFutureRequirementsPastDue obj) GHC.Base.<> ("pending_verification" Data.Aeson.Types.ToJSON..= accountCapabilityFutureRequirementsPendingVerification obj))))))))
