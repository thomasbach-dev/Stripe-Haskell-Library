...
data PaymentPagesCheckoutSessionAfterExpirationRecovery = PaymentPagesCheckoutSessionAfterExpirationRecovery
  { -- | allow_promotion_codes: Enables user redeemable promotion codes on the recovered Checkout Sessions. Defaults to \`false\`
    ...
    paymentPagesCheckoutSessionAfterExpirationRecoveryExpiresAt :: (GHC.Maybe.Maybe GHC.Types.Int),
    -- | url: URL that creates a new Checkout Session when clicked that is a copy of this expired Checkout Session
    --
    -- Constraints:
    --
    -- * Maximum length of 5000
    paymentPagesCheckoutSessionAfterExpirationRecoveryUrl :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionAfterExpirationRecovery where
  toJSON obj = Data.Aeson.Types.Internal.object ("allow_promotion_codes" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionAfterExpirationRecoveryAllowPromotionCodes obj : "enabled" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionAfterExpirationRecoveryEnabled obj : "expires_at" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionAfterExpirationRecoveryExpiresAt obj : "url" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionAfterExpirationRecoveryUrl obj : GHC.Base.mempty)
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("allow_promotion_codes" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionAfterExpirationRecoveryAllowPromotionCodes obj) GHC.Base.<> (("enabled" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionAfterExpirationRecoveryEnabled obj) GHC.Base.<> (("expires_at" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionAfterExpirationRecoveryExpiresAt obj) GHC.Base.<> ("url" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionAfterExpirationRecoveryUrl obj))))
