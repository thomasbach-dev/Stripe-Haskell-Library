...
data PaymentIntent = PaymentIntent
  { -- | amount: Amount intended to be collected by this PaymentIntent. A positive integer representing how much to charge in the [smallest currency unit](https:\/\/stripe.com\/docs\/currencies\#zero-decimal) (e.g., 100 cents to charge \$1.00 or 100 to charge ¥100, a zero-decimal currency). The minimum amount is \$0.50 US or [equivalent in charge currency](https:\/\/stripe.com\/docs\/currencies\#minimum-and-maximum-charge-amounts). The amount value supports up to eight digits (e.g., a value of 99999999 for a USD charge of \$999,999.99).
    ...
    paymentIntentAutomaticPaymentMethods :: (GHC.Maybe.Maybe PaymentIntentAutomaticPaymentMethods'),
...
data PaymentIntentAutomaticPaymentMethods' = PaymentIntentAutomaticPaymentMethods'
  { -- | enabled: Automatically calculates compatible payment methods
    paymentIntentAutomaticPaymentMethods'Enabled :: (GHC.Maybe.Maybe GHC.Types.Bool)
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentAutomaticPaymentMethods' where
  toJSON obj = Data.Aeson.Types.Internal.object ("enabled" Data.Aeson.Types.ToJSON..= paymentIntentAutomaticPaymentMethods'Enabled obj : GHC.Base.mempty)
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs ("enabled" Data.Aeson.Types.ToJSON..= paymentIntentAutomaticPaymentMethods'Enabled obj)

instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentAutomaticPaymentMethods' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentIntentAutomaticPaymentMethods'" (\obj -> GHC.Base.pure PaymentIntentAutomaticPaymentMethods' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "enabled"))

-- | Create a new 'PaymentIntentAutomaticPaymentMethods'' with all required fields.
mkPaymentIntentAutomaticPaymentMethods' :: PaymentIntentAutomaticPaymentMethods'
mkPaymentIntentAutomaticPaymentMethods' = PaymentIntentAutomaticPaymentMethods' {paymentIntentAutomaticPaymentMethods'Enabled = GHC.Maybe.Nothing}
...
data PaymentIntentLastPaymentError'Source' = PaymentIntentLastPaymentError'Source'
  { -- | account: The ID of the account that the bank account is associated with.
    ...
    --
    -- * Maximum length of 5000
    paymentIntentLastPaymentError'Source'AccountType :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
    -- | ach_credit_transfer
...
mkPaymentIntentLastPaymentError'Source' =
  PaymentIntentLastPaymentError'Source'
    { paymentIntentLastPaymentError'Source'Account = GHC.Maybe.Nothing,
      ...
      paymentIntentLastPaymentError'Source'AccountType = GHC.Maybe.Nothing,
...
data PaymentIntentNextAction' = PaymentIntentNextAction'
  { -- | alipay_handle_redirect:
    ...
    paymentIntentNextAction'WechatPayDisplayQrCode :: (GHC.Maybe.Maybe PaymentIntentNextActionWechatPayDisplayQrCode),
    -- | wechat_pay_redirect_to_android_app:
    paymentIntentNextAction'WechatPayRedirectToAndroidApp :: (GHC.Maybe.Maybe PaymentIntentNextActionWechatPayRedirectToAndroidApp),
    -- | wechat_pay_redirect_to_ios_app:
    paymentIntentNextAction'WechatPayRedirectToIosApp :: (GHC.Maybe.Maybe PaymentIntentNextActionWechatPayRedirectToIosApp)
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
mkPaymentIntentNextAction' =
  PaymentIntentNextAction'
    { paymentIntentNextAction'AlipayHandleRedirect = GHC.Maybe.Nothing,
      ...
      paymentIntentNextAction'WechatPayDisplayQrCode = GHC.Maybe.Nothing,
      paymentIntentNextAction'WechatPayRedirectToAndroidApp = GHC.Maybe.Nothing,
      paymentIntentNextAction'WechatPayRedirectToIosApp = GHC.Maybe.Nothing
    }
...
data PaymentIntentPaymentMethodOptions' = PaymentIntentPaymentMethodOptions'
  { -- | acss_debit:
    ...
    -- | ideal:
    paymentIntentPaymentMethodOptions'Ideal :: (GHC.Maybe.Maybe PaymentMethodOptionsIdeal),
    -- | interac_present:
    paymentIntentPaymentMethodOptions'InteracPresent :: (GHC.Maybe.Maybe PaymentMethodOptionsInteracPresent),
    -- | klarna:
    paymentIntentPaymentMethodOptions'Klarna :: (GHC.Maybe.Maybe PaymentMethodOptionsKlarna),
    -- | oxxo:
    ...
    -- | wechat_pay:
    paymentIntentPaymentMethodOptions'WechatPay :: (GHC.Maybe.Maybe PaymentMethodOptionsWechatPay)
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptions' where
  toJSON obj = Data.Aeson.Types.Internal.object ("acss_debit" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'AcssDebit obj : "afterpay_clearpay" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'AfterpayClearpay obj : "alipay" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'Alipay obj : "bancontact" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'Bancontact obj : "boleto" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'Boleto obj : "card" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'Card obj : "card_present" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'CardPresent obj : "ideal" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'Ideal obj : "interac_present" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'InteracPresent obj : "klarna" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'Klarna obj : "oxxo" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'Oxxo obj : "p24" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'P24 obj : "sepa_debit" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'SepaDebit obj : "sofort" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'Sofort obj : "wechat_pay" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'WechatPay obj : GHC.Base.mempty)
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("acss_debit" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'AcssDebit obj) GHC.Base.<> (("afterpay_clearpay" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'AfterpayClearpay obj) GHC.Base.<> (("alipay" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'Alipay obj) GHC.Base.<> (("bancontact" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'Bancontact obj) GHC.Base.<> (("boleto" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'Boleto obj) GHC.Base.<> (("card" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'Card obj) GHC.Base.<> (("card_present" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'CardPresent obj) GHC.Base.<> (("ideal" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'Ideal obj) GHC.Base.<> (("interac_present" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'InteracPresent obj) GHC.Base.<> (("klarna" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'Klarna obj) GHC.Base.<> (("oxxo" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'Oxxo obj) GHC.Base.<> (("p24" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'P24 obj) GHC.Base.<> (("sepa_debit" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'SepaDebit obj) GHC.Base.<> (("sofort" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'Sofort obj) GHC.Base.<> ("wechat_pay" Data.Aeson.Types.ToJSON..= paymentIntentPaymentMethodOptions'WechatPay obj)))))))))))))))
...
mkPaymentIntentPaymentMethodOptions' =
  PaymentIntentPaymentMethodOptions'
    { paymentIntentPaymentMethodOptions'AcssDebit = GHC.Maybe.Nothing,
      ...
      paymentIntentPaymentMethodOptions'Ideal = GHC.Maybe.Nothing,
      paymentIntentPaymentMethodOptions'InteracPresent = GHC.Maybe.Nothing,
      paymentIntentPaymentMethodOptions'Klarna = GHC.Maybe.Nothing,
      ...
      paymentIntentPaymentMethodOptions'WechatPay = GHC.Maybe.Nothing
    }
