...
data SetupIntentLastSetupError'Source' = SetupIntentLastSetupError'Source'
  { -- | account: The ID of the account that the bank account is associated with.
    ...
    --
    -- * Maximum length of 5000
    setupIntentLastSetupError'Source'AccountType :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
    -- | ach_credit_transfer
...
mkSetupIntentLastSetupError'Source' =
  SetupIntentLastSetupError'Source'
    { setupIntentLastSetupError'Source'Account = GHC.Maybe.Nothing,
      ...
      setupIntentLastSetupError'Source'AccountType = GHC.Maybe.Nothing,
