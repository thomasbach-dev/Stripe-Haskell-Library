...
data PaymentMethodDetailsWechatPay = PaymentMethodDetailsWechatPay
  { -- | fingerprint: Uniquely identifies this particular WeChat Pay account. You can use this attribute to check whether two WeChat accounts are the same.
    ...
    paymentMethodDetailsWechatPayFingerprint :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
    -- | transaction_id: Transaction ID of this particular WeChat Pay transaction.
    --
    -- Constraints:
    --
    -- * Maximum length of 5000
    paymentMethodDetailsWechatPayTransactionId :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsWechatPay where
  toJSON obj = Data.Aeson.Types.Internal.object ("fingerprint" Data.Aeson.Types.ToJSON..= paymentMethodDetailsWechatPayFingerprint obj : "transaction_id" Data.Aeson.Types.ToJSON..= paymentMethodDetailsWechatPayTransactionId obj : GHC.Base.mempty)
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("fingerprint" Data.Aeson.Types.ToJSON..= paymentMethodDetailsWechatPayFingerprint obj) GHC.Base.<> ("transaction_id" Data.Aeson.Types.ToJSON..= paymentMethodDetailsWechatPayTransactionId obj))
